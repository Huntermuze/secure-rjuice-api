...
class Connection:
    ...
    def __init__(self, address, port):
        ...
        self.lastSent = ""
        # ASSIGNMENT 3 MODIFICATION - Modified by Huntermuze
        # The connection object will hold the encryption object, as encryption is related to securing connections.
        # (Separation of concerns).
        self.encryption = Encryption(self.sendReceive(b'publicKey.request'))
